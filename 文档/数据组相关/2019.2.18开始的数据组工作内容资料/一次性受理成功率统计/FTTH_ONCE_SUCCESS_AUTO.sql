create or replace procedure FTTH_ONCE_SUCCESS_AUTO is
BEGIN
declare
  cursor c_ooi is 
  ...
  and
  (
    (ooi.finish_time>=to_date(TO_CHAR(SYSDATE-1,'YYYYMMDD')||'000000','yyyy-mm-dd hh24:mi:ss') 
     and ooi.finish_time <to_date(TO_CHAR(SYSDATE,'YYYYMMDD')||'000000','yyyy-mm-dd hh24:mi:ss')
    )
    or
    (to_date(ooi.ACCEPT_TIME,'yyyy-mm-dd hh24:mi:ss')>=to_date(TO_CHAR(SYSDATE-1,'YYYYMMDD')||'000000','yyyy-mm-dd hh24:mi:ss') 
     and to_date(ooi.ACCEPT_TIME,'yyyy-mm-dd hh24:mi:ss') <to_date(TO_CHAR(SYSDATE,'YYYYMMDD')||'000000','yyyy-mm-dd hh24:mi:ss')
    )
  )
