...
select * from ra_workorder_request where crm_order_number = '2-30247695499'
...
select * from RA_WORKORDER_REQUEST where CRM_ORDER_NUMBER = 'WMX2020021405150807' and REQUEST_TYPE like '%queryIntResService%' order by RECEIVE_TIME desc;
