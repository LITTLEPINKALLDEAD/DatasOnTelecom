select * from wp_srq where p6_order_id = '35096'; --工单处理状态
-- order by receive_dts desc 
select * from wp_p6_req where p6_order_id = '35096'; --人工工单内容
-- order by CREATE_DTS desc 

--(2019)/19076225_0001PZ的P6号为15094
--(2019)/19076222_0001PZ,P6号为15091

select a.p6_req_content from wp_p6_req a where a.crm_order_id in ('2-30261123955')  and a.plane_type='111'
