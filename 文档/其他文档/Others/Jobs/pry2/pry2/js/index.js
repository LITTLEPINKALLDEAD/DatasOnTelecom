//抽奖人员名单
var allPerson = "市场部张聪;陈列部大大葱;行政部哈哈哈;仓库哇哇哇哇;奥莱嘻嘻嘻;WK货品嘿嘿嘿;奥莱李国庆;奥莱杨广霞;市场部樊清华;PB运营田力玮;奥莱宋浩;实在编不出了";
//领导人员名单
...
$(function () {
    ...
    $("#btnStart").on("click", function () {
        ...
        if ($("#btnStart").text() === "开始") {
			...
			//2018.1.26
			$("#res").fadeIn().find("div").removeClass().addClass("p" + luckyDrawNum);//隐藏输入框，显示中奖框
    ...
    $("#btnReset").on("click", function () {
        ...
        showConfirm("确认重置吗？所有历史记录全部清空！", function () {
            //熏置未中奖人员名单
