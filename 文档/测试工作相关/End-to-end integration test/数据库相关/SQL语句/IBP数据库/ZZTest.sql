select * from intf_requestlog where crmquotenumber in ('WMX2020070105552001','WMX2020070105552008');--接口表，IBP发给综资的信息
...
-- 在综资界面配置的时候，都是在子单中操作
SELECT * from c_Servicecurrent WHERE globalserviceid in ('KD2003070460','KD2003070463');--在途服务表,根据c_serviceorder的GLOBALSERVICEID查询,即设备编号
