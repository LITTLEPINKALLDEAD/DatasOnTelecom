...
select asap.request_type,asap.platform,asap.work_order_request from asap_workorder_request asap where asap.crm_order_number = 'WMX2020041505328048';
-- 验证方法ims、ONU、SHLR工单，serviceProperty_new这种是新节点，后面是old的是老节点，报文里应该只有新节点没有老节点的

select t.action_code,t.* from pai_workorder_request t where crm_order_number = 'WMX2020041505328048';
